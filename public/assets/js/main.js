(function ($) {
  ...
  $("#adv-serch").on("click", function () {
    var _self = $(this);
    _self
      .parents(".adv-search-wrap")
      .find(".advance-search-form")
      .slideToggle();
  ...
  /*-------------------------------------
    ...
    -------------------------------------*/
  if (
    $("header .header-main-menu").length &&
    $("header .header-main-menu").hasClass("header-sticky")
  ) {
    ...
    $(window).on("scroll load", function (event) {
      ...
      if (st > header_position.top) {
        $(".header-table").length
          ? $("header .header-table").addClass("header-fixed")
          : $("header .header-main-menu").addClass("header-fixed");
      } else {
        $(".header-table").length
          ? $("header .header-table").removeClass("header-fixed")
          : $("header .header-main-menu").removeClass("header-fixed");
      }
